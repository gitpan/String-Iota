# This Makefile is for the String::Iota extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/String/Iota.pm]
#     AUTHOR => q[Lincoln Ombelets <Linco@apple.com>]
#     NAME => q[String::Iota]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/String/Iota.pm]
...
PARENT_NAME = String
DLBASE = $(BASEEXT)
VERSION_FROM = lib/String/Iota.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/String/Iota.pm

PM_TO_BLIB = lib/String/Iota.pm \
...
DISTNAME = String-Iota
DISTVNAME = String-Iota-0.85
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/String/Iota.pm $(INST_MAN3DIR)/String::Iota.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         String-Iota' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.85' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/String/Iota.pm' >> META_new.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,85,0,0">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <TITLE>$(DISTNAME)</TITLE>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Tiny interface to some useful string functions</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Lincoln Ombelets &lt;Linco@apple.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/String/Iota.pm blib/lib/String/Iota.pm 
